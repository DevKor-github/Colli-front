import type { teamMember, teamMemberResponse } from '@/api/types/teamMember'

export const TEAMMEMBER_LIST_MOCK: teamMember[] = [
  {
    id: 0,
    name: '김하람',
    department: '고려대학교 디자인조형학부',
    email: 'skyywwindd@gmail.com',
    division: '디자인',
  ...
  },
  {
    ...
    email: 'ncl002@korea.ac.kr',
    division: '백엔드',
    imgSrc: require('@assets/Images/dummy.jpg')
  }
]

export const TEAMMEMBER_RES_MOCK: teamMemberResponse = {
  dataList: TEAMMEMBER_LIST_MOCK
}
